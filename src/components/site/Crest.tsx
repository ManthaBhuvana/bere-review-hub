    ...
    >
      <defs>
        <linearGradient id="crestG" x1="0" x2="0" y1="0" y2="1">
          <stop offset="0" stopColor="oklch(0.30 0.09 255)" />
          <stop offset="1" stopColor="oklch(0.16 0.07 255)" />
        </linearGradient>
      </defs>
      {/* Shield */}
      <path
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <line x1="24" y1="24" x2="24" y2="38" stroke="oklch(0.82 0.13 85)" strokeWidth="1.5" />
      {/* Torch flame */}
      <path
        d="M24 8 C22 12 20 14 20 17 C20 19.5 22 21 24 21 C26 21 28 19.5 28 17 C28 14 26 12 24 8 Z"
        fill="oklch(0.82 0.13 85)"
      />
      <line x1="24" y1="21" x2="24" y2="24" stroke="oklch(0.82 0.13 85)" strokeWidth="1.5" />
    </svg>
  );
}
