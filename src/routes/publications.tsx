...
import { ISSUE_DATE, SITE_NAME } from "@/lib/site";
...
export const Route = createFileRoute("/publications")({
  ...
  head: () =>
    seo({
      ...
      ogTitle: "Publications Archive — The Venugopal Bere Educational Review",
      description:
        "Archive of issues and publications on educational leadership, teacher development, and classroom practice, with full citation details and downloadable PDFs.",
      keywords:
        "publications, review archive, educational leadership, teacher professional development, citation, Venugopal Bere",
      path: "/publications",
    }),
});

// PDFs are stored in /public/images/pdfs and served from your own domain,
// e.g. pdfUrl: "/images/pdfs/volume-1.pdf".
...
const PUBS = [
  ...
  },
  {
    ...
    pdfUrl:
      "/images/pdfs/leaders-toolkit.pdf",
