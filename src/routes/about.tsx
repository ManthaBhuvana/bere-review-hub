...
import { FOUNDER_NAME, FOUNDER_TITLE, LINKEDIN_URL, SITE_NAME } from "@/lib/site";
...
export const Route = createFileRoute("/about")({
  ...
  head: () =>
    seo({
      title: `About Venugopal Bere — ${SITE_NAME}`,
      ogTitle: "About Venugopal Bere — Founder & Editor",
      description:
        "Venugopal Bere, Founder & Editor: Academic Director, Teacher Educator, and CBSE Resource Person with 30+ years bridging educational research, leadership, and classroom practice.",
      keywords:
        "Venugopal Bere, Educational Leadership, Teacher Education, CBSE Resource Person, Instructional Leadership, Teacher Professional Development, NEP 2020, NCF-SE 2023",
      path: "/about",
    }),
});
...
const TRAINING_PHOTOS = [
  {
    ...
    alt: "National Curriculum Framework for School Education 2023",
  },
  {
    src: "/images/training/photo-2.jpeg",
    alt: "In-service Teacher Trainings",
  },
  {
    src: "/images/training/photo-3.jpeg",
    alt: "Workshop on NEP 2020",
  },
  {
    src: "/images/training/photo-4.jpeg",
    alt: "In-service Teacher Trainings",
  },
];
...
const CREDENTIALS = [
  ...
  },
  {
    ...
    sub: "Multiple Campuses",
  },
  {
    icon: Users,
    label: "CBSE Resource Person",
    sub: "Capacity Building",
  },
  {
    icon: BookOpen,
    label: "Teacher Educator",
    sub: "Professional Learning",
  },
  {
    icon: GraduationCap,
    label: "Leadership Practitioner",
    sub: "School Improvement",
  },
];
    ...
    <>
      <div className="container-editorial grid gap-10 py-12 md:py-16 lg:grid-cols-[320px_1fr] lg:gap-16">
        ...
        <aside className="space-y-6 lg:sticky lg:top-24 lg:self-start">
          ...
          {/* LinkedIn */}
          <div className="on-ink rounded-2xl border border-primary/40 bg-ink p-5 text-center">
            <div className="text-xs font-semibold uppercase tracking-[0.25em] text-primary">
              Connect With Me
            </div>

            <p className="mt-2 text-xs text-muted-foreground">
              View my professional profile, publications, and educational
              initiatives on LinkedIn.
            </p>
          ...
          <div className="rounded-2xl border border-border bg-card p-5 text-center">
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Download a printable profile summarising credentials, philosophy,
              and contact details.
            </p>

            <a
              href="/images/pdfs/about-the-author.pdf"
              download
              target="_blank"
              rel="noreferrer"
        ...
        <article className="min-w-0">
          ...
          <p className="mt-2 text-lg text-primary">
            Educational Leader · Teacher Educator · CBSE Resource Person ·
            Practitioner-Scholar
          </p>

          {/* Introduction */}
          <h2 className="mt-10 font-serif text-2xl text-primary md:text-3xl">
            Bridging Educational Research with School Leadership and Classroom
            Practice
          </h2>

          {/* Introduction */}
<div className="prose-lg mt-6 space-y-5 text-base leading-relaxed text-left text-foreground/90 md:text-justify">
  <p>
    ...
    grounded in three interconnected principles:
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {[
              {
                icon: Search,
                t: "Evidence should inform educational practice.",
              },
              {
                icon: Users,
                t: "Leadership should develop people before programmes.",
              },
              {
                icon: Target,
              ...
              <div
                key={t}
                className="rounded-xl card-ash p-5"
              >
          ...
          {/* Framework */}
<div className="prose-lg mt-8 space-y-5 text-base leading-relaxed text-left text-foreground/90 md:text-justify">
  <p>
  ...
  <p>
    ...
    leaders in translating research into action.
          ...
          {/* Scholarly Work */}
<div className="prose-lg mt-10 space-y-5 text-base leading-relaxed text-left text-foreground/90 md:text-justify">
  <p>
    His current scholarly interests focus on educational leadership,
    teacher professional development, competency-based education, and
  ...
  <p>
    ...
    dialogue and continuous improvement within schools.
          ...
          <figure className="mt-12 overflow-hidden rounded-2xl border border-primary/30 card-ash p-8">
            ...
            <blockquote className="mt-5 font-serif text-2xl italic leading-relaxed text-left text-ash-foreground md:text-justify md:text-3xl">
              <span className="mr-1 font-serif text-4xl text-primary">
                “
              </span>
              Educational excellence is not achieved through isolated
              initiatives. It is built when schools create cultures where
              teachers continue to learn, leaders continue to support, and
              students continue to thrive.
              <span className="ml-1 font-serif text-4xl text-primary">
                ”
              </span>
            </blockquote>
            ...
            <figcaption className="mt-6 flex flex-col items-start justify-between gap-4 border-t border-ash-foreground/15 pt-5 sm:flex-row sm:items-center">
              <div>
                <div className="font-serif text-lg text-ash-foreground">
                  Venugopal Bere
                </div>
          ...
          <section className="container-editorial mt-16">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <Link
                to="/frameworks"
                className="rounded-xl border border-border p-5 hover:border-primary"
              >
