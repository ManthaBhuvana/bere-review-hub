...
export const Route = createFileRoute("/articles/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        {
          title: `${article.title} — The Venugopal Bere Educational Review`,
        },
        {
          name: "description",
          content: description,
        ...
        {
          name: "keywords",
          content: `${article.tag}, school leadership, educational leadership, Venugopal Bere, teacher development, NEP 2020`,
        },
        {
          property: "og:type",
          content: "article",
