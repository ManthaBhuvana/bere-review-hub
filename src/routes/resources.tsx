  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "A growing professional resource library for school leaders, teachers, teacher educators, and policy leaders — organised under For School Leaders, For Teachers, For Teacher Educators, Policy to Practice, and Videos & Talks.",
      },
      {
        name: "keywords",
        content:
      ...
      {
        property: "og:title",
        content: "School Leadership Resource Centre",
      },
      {
        property: "og:description",
        content:
          "Downloadable guides, toolkits, rubrics, and workshop videos.",
      },
      {
        property: "og:url",
        content: "/resources",
...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      {
        label: "Volume 1 — Full Issue",
        href: "/articles/volume-1",
        internal: true,
      },
      {
        label: "School Readiness Self-Assessment",
        href: "/images/framework/school-readiness-self-assessment.png",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        label: "Foreword — Volume 1",
        href: "/articles/foreword",
        internal: true,
      },
      {
        label: "Bere Policy-to-Practice Bridge",
        href: "/images/framework/bere-policy-practice-bridge.png",
      },
      {
        label: "Traditional Practice vs. NEP/NCF-Aligned Practice",
        href: "/images/framework/traditional-vs-nep-practice.png",
      },
    ],
  },
  {
