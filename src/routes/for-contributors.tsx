...
export const Route = createFileRoute("/for-contributors")({
  ...
  head: () => ({
    meta: [
      { title: "For Contributors — The Venugopal Bere Educational Review" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "For Contributors" },
      {
        property: "og:description",
        content: "Everything you need to know before submitting to the Review.",
      },
      { property: "og:url", content: "/for-contributors" },
    ],
    links: [{ rel: "canonical", href: "/for-contributors" }],
  }),
});
