  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "current issue, educational review, teacher professional development, NEP 2020, school leadership",
      },
      {
        property: "og:title",
        content: "Current Issue — Volume 1",
      },
      {
        property: "og:description",
        content:
          "The Editorial, Foreword, and Leader's Toolkit from the inaugural issue of the Review.",
      },
      {
        property: "og:url",
    ...
    <>
      ...
      <section className="container-editorial mt-8 grid gap-6 rounded-2xl border border-border bg-card p-6 md:grid-cols-[200px_1fr] md:p-8">
        <img
          ...
          alt="Cover of Volume 1 of The Venugopal Bere Educational Review"
